...
var settings = new SimpleSchema ({
  ...
  musicApproval: {
    type: Boolean,
    label: "Require approval of Music requests",
    defaultValue: false,
    optional: true
  },
  weeklyLimit: {
  ...
  musicWeeklyLimit: {
    type: Number,
    label: "Weekly user request limit for Music",
    defaultValue: 5
  },
  ...
  headphonesURL: {
    type: String,
    label: "Headphones server IP or Hostname",
    defaultValue: "192.168.0.1",
    optional: true
  },
  headphonesPORT: {
    type: Number,
    label: "Headphones server port",
    defaultValue: 8181,
    optional: true
  },
  headphonesSSL: {
    type: Boolean,
    label: "Enable Headphones SSL",
    defaultValue: false,
    optional: true
  },
  headphonesAPI: {
    type: String,
    label: "Headphones API key",
    defaultValue: "abcd1234",
    optional: true
  },
  headphonesENABLED: {
  ...
  headphonesDIRECTORY: {
    type: String,
    label: "Headphones sub-directory",
    defaultValue: "",
    optional: true
  },
